  ...
  return (
    ...
    >
      ...
      <div className="relative px-6 py-10 md:px-14 md:py-16">
        <p className="text-center text-xs md:text-sm font-serif tracking-[0.4em] uppercase text-cinnabar/80">
          Wedding Invitation
        </p>
          ...
          <div className="space-y-6">
            <div className="rounded-3xl border border-cinnabar/15 bg-white/70 p-6">
              ...
              <ul className="mt-3 space-y-2 text-base md:text-lg font-serif text-stone-700">
                <li>
                  <span className="inline-block w-16 text-cinnabar/80">日期</span>114/11/29（星期六）
                </li>
                <li>
                  <span className="inline-block w-16 text-cinnabar/80">時間</span>中午 12:00（需再確認是否為 12:30）
                </li>
                <li>
                  <span className="inline-block w-16 text-cinnabar/80">地點</span>臻愛花園飯店
                </li>
                <li>
                  <span className="inline-block w-16 text-cinnabar/80">地址</span>台中市烏日區高鐵路三段 168 號
                </li>
              </ul>
            </div>
            <div className="rounded-3xl border border-cinnabar/15 bg-white/70 p-6">
              ...
              <ul className="mt-3 space-y-2 text-base md:text-lg font-serif text-stone-700">
                <li>
                  <span className="inline-block w-16 text-cinnabar/80">日期</span>114/11/30（星期日）
                </li>
                <li>
                  <span className="inline-block w-16 text-cinnabar/80">時間</span>12:00 入席
                </li>
                <li>
                  <span className="inline-block w-16 text-cinnabar/80">地點</span>晶饌會館
                </li>
                <li>
                  <span className="inline-block w-16 text-cinnabar/80">地址</span>嘉義市西區友忠路 508 號
                </li>
              </ul>
            </div>
          </div>
